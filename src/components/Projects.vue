<template>
    <section class="mt-14 md:mx-auto pt-8 px-4 md:px-0 w-full md:w-4/5 2xl:w-1/3">
...
<script>
import ProjectCard from './fragments/ProjectCard.vue';
        ...
        return {
            projects: [
                ...
                },
                {
                    ...
                    projectUrl: 'https://moilu.github.io/js-movie-app/',
                },
            ]
        }
    }
